...
#  May 14, 2022 12:33:37 AM CST  platform: Windows NT
set vTcl(timestamp) ""
...
set vTcl(actual_gui_analog) #edf2f2
...
proc vTclWindow.top45 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 600x801+747+186
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ttk::combobox $site_3_0.tCo81 \
        -values {both yes no {}} -font TkTextFont -textvariable combobox \
        -foreground {} -background {} -takefocus {} 
    ...
    label $site_3_0.lab88 \
        -activeforeground SystemButtonText -anchor w -background #edf0f3 \
    ...
    checkbutton $top.che126 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -selectcolor #d9d9d9 -text {No divide} -variable che108 
    ...
    ttk::combobox $top.tCo129 \
        -values {longest first no} -font TkTextFont -textvariable combobox \
        -foreground {} -background {} -takefocus {} 
    vTcl:DefineAlias "$top.tCo129" "TCombobox1_2" vTcl:WidgetProc "gb2fasta" 1
    button $top.but132 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #edf0f3 -compound left -disabledforeground #a3a3a3 \
        -font {-family {Microsoft YaHei UI} -size 12 -weight normal -slant roman -underline 0 -overstrike 0} \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Button 
...
proc vTclWindow.top46 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor black 
    wm focusmodel $top passive
    wm geometry $top 800x601+482+818
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
