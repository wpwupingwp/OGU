...
#    Jun 02, 2022 02:34:27 PM CST  platform: Darwin
...
class gb2fasta:
    def __init__(self, top=None):
        ...
        self.TCombobox_molecular.place(relx=0.719, rely=0.217, relheight=0.095
        ...
        self.TCombobox_refseq.place(relx=0.201, rely=0.541, relheight=0.095
                                    , relwidth=0.314, bordermode='ignore')
