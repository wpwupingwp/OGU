...
#    May 13, 2022 11:01:17 PM CST  platform: Windows NT
...
class gb2fasta:
    def __init__(self, top=None):
        ...
        self.Labelframe1.place(relx=0.016, rely=0.0, relheight=0.376
                , relwidth=0.945)
        ...
        self.TLabel1.place(relx=0.055, rely=0.084, height=42, width=106
                , bordermode='ignore')
        ...
        self.gb_file.place(relx=0.255, rely=0.1, relheight=0.1, relwidth=0.562
                , bordermode='ignore')
        self.gb_file.configure(takefocus="")
        self.gb_file.configure(cursor="fleur")

        self.open_gb = ttk.Button(self.Labelframe1)
        self.open_gb.place(relx=0.818, rely=0.1, height=30, width=90
                , bordermode='ignore')
        self.open_gb.configure(command=ui_support.open_file)
        self.open_gb.configure(takefocus="")
        self.open_gb.configure(text='''Open''')
        self.open_gb.configure(compound='left')

        self.TSeparator1 = ttk.Separator(self.Labelframe1)
        self.TSeparator1.place(relx=0.092, rely=0.234, relwidth=0.88
                , bordermode='ignore')

        self.TLabel1 = ttk.Label(self.Labelframe1)
        self.TLabel1.place(relx=0.036, rely=0.266, height=32, width=54
                , bordermode='ignore')
        self.TLabel1.configure(background="#edf0f3")
        self.TLabel1.configure(foreground="#000000")
        self.TLabel1.configure(font="-family {Microsoft YaHei UI} -size 12")
        ...
        self.gb_file_1.place(relx=0.2, rely=0.266, relheight=0.1, relwidth=0.327
                , bordermode='ignore')
        self.gb_file_1.configure(takefocus="")
        self.gb_file_1.configure(cursor="fleur")

        self.TSeparator1 = ttk.Separator(self.Labelframe1)
        self.TSeparator1.place(relx=0.545, rely=0.316, relheight=0.669
                , bordermode='ignore')
        self.TSeparator1.configure(orient="vertical")

        self.TLabel1_1 = ttk.Label(self.Labelframe1)
        self.TLabel1_1.place(relx=0.019, rely=0.366, height=43, width=95
                , bordermode='ignore')
        ...
        self.gb_file_1_1 = ttk.Entry(self.Labelframe1)
        self.gb_file_1_1.place(relx=0.2, rely=0.4, relheight=0.1, relwidth=0.327
                , bordermode='ignore')
        self.gb_file_1_1.configure(takefocus="")
        self.gb_file_1_1.configure(cursor="fleur")

        self.TLabel1_2 = ttk.Label(self.Labelframe1)
        self.TLabel1_2.place(relx=0.563, rely=0.266, height=32, width=85
                , bordermode='ignore')
        ...
        self.TCombobox1.place(relx=0.719, rely=0.281, relheight=0.094
        ...
        self.TLabel1_2_1.place(relx=0.565, rely=0.406, height=32, width=85
                , bordermode='ignore')
        ...
        self.TCombobox1_1.place(relx=0.719, rely=0.406, relheight=0.094
                , relwidth=0.257, bordermode='ignore')
        ...
        self.TLabel1_1_1.place(relx=0.017, rely=0.531, height=30, width=90
                , bordermode='ignore')
        ...
        self.TCombobox1_1_1 = ttk.Combobox(self.Labelframe1)
        self.TCombobox1_1_1.place(relx=0.24, rely=0.563, relheight=0.094
                , relwidth=0.257, bordermode='ignore')
        self.value_list = ['ignore','both','no','mitochondrion','chloroplast',]
        self.TCombobox1_1_1.configure(values=self.value_list)
        self.TCombobox1_1_1.configure(textvariable=self.combobox)
        self.TCombobox1_1_1.configure(takefocus="")

        self.TLabel1_1_1_1 = ttk.Label(self.Labelframe1)
        self.TLabel1_1_1_1.place(relx=0.0, rely=0.688, height=30, width=100
                , bordermode='ignore')
        ...
        self.TCombobox1_1_1_1 = ttk.Combobox(self.Labelframe1)
        self.TCombobox1_1_1_1.place(relx=0.24, rely=0.688, relheight=0.094
                , relwidth=0.257, bordermode='ignore')
        self.value_list = ['both','yes','no',]
        self.TCombobox1_1_1_1.configure(values=self.value_list)
        self.TCombobox1_1_1_1.configure(textvariable=self.combobox)
        self.TCombobox1_1_1_1.configure(takefocus="")

        self.TLabel1_1_1_1_1 = ttk.Label(self.Labelframe1)
        self.TLabel1_1_1_1_1.place(relx=-0.017, rely=0.844, height=30, width=100
                , bordermode='ignore')
