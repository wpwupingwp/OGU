...
#    May 15, 2022 10:51:00 AM CST  platform: Darwin
...
class gb2fasta:
    def __init__(self, top=None):
        ...
        self.allow_repeat = tk.StringVar()
        self.allow_invert_repeat = tk.StringVar()
        self.allow_mosaic_repeat = tk.StringVar()
        self.expand = tk.StringVar()
        self.max_name_len = tk.StringVar()
        self.max_gene_len = tk.StringVar()
        self.no_divide = tk.StringVar()
        ...
        self.Checkbutton1_1_1.configure(textvariable=self.allow_repeat)
        self.allow_repeat.set('''Allow repeat''')
        ...
        self.Checkbutton1_1_1_1.configure(textvariable=self.allow_invert_repeat)
        self.allow_invert_repeat.set('''Allow invert repeat''')
        ...
        self.Checkbutton1_1_1_1_1.configure(textvariable=self.allow_mosaic_repeat)
        self.allow_mosaic_repeat.set('''Allow mosaic repeat''')
        ...
        self.Checkbutton1.configure(textvariable=self.no_divide)
        self.no_divide.set('''No divide''')
        ...
        self.Checkbutton1_1.configure(textvariable=self.rename)
        self.rename.set('''Rename gene''')
