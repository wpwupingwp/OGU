...
#    Jun 02, 2022 03:48:49 PM CST  platform: Darwin
...
class gb2fasta:
    def __init__(self, top=None):
        ...
        self.gb_entry_tooltip = \
        ToolTip(self.gb_entry, self.tooltip_font, '''gb format files''')
        ...
        ToolTip(self.TCombobox_refseq, self.tooltip_font, '''Use RefSeq or not''')
        ...
        ToolTip(self.count_entry, self.tooltip_font, '''numbers of sequences to download, 0 for no limit''')
        ...
        ToolTip(self.min_len_entry, self.tooltip_font, '''sequence length limit''')
        ...
        ToolTip(self.exclude_entry, self.tooltip_font, '''exclude expression''')
        ...
        self.tooltip_font = "TkDefaultFont"
        self.query_entry_tooltip = \
        ToolTip(self.query_entry, self.tooltip_font, '''Entrez query string''')
        ...
        self.Button1.configure(command=ui_support.)
        ...
        ToolTip(self.expand_entry, self.tooltip_font, '''expand for primer design''')
        ...
        ToolTip(self.max_name_len_entry, self.tooltip_font, '''max feature name length''')
        ...
        ToolTip(self.max_gene_len_entry, self.tooltip_font, '''max fragment sequence length''')
        ...
        ToolTip(self.TCombobox_unique, self.tooltip_font, '''methods to remove redundant records''')
...
class evaluate:
    def __init__(self, top=None):
        ...
        ToolTip(self.fasta_entry, self.tooltip_font, '''unaligned fasta files''')
        ...
        ToolTip(self.fasta_folder_entry, self.tooltip_font, '''unaligned fasta files''')
        ...
        ToolTip(self.aln_entry, self.tooltip_font, '''unaligned fasta files''')
        ...
        self.tooltip_font = "TkDefaultFont"
        self.out_entry_tooltip = \
        ToolTip(self.out_entry, self.tooltip_font, '''unaligned fasta files''')
...
class primer:
    def __init__(self, top=None):
        ...
        self.aln_entry = ttk.Entry(self.Labelframe1)
        self.aln_entry.place(relx=0.314, rely=0.2, relheight=0.35, relwidth=0.489
                , bordermode='ignore')
        self.aln_entry.configure(textvariable=self.aln)
        self.aln_entry.configure(takefocus="")
        self.aln_entry.configure(cursor="fleur")
        ...
        ToolTip(self.aln_folder_entry, self.tooltip_font, '''unaligned fasta files''')
        ...
        ToolTip(self.coverage_entry, self.tooltip_font, '''minimal coverage of primer on alignment''')
        ...
        ToolTip(self.mismatch_entry, self.tooltip_font, '''maximum mismatch bases in primer''')
        ...
        ToolTip(self.resolution_entry, self.tooltip_font, '''minimal resolution of amplified fragment''')
        ...
        ToolTip(self.top_n_entry, self.tooltip_font, '''Only keep top best primers''')
        ...
        ToolTip(self.amin_entry, self.tooltip_font, '''including primer length''')
